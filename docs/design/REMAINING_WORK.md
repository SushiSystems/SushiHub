...
| 3 | Sushi ID, in the sushiweb repository: device authorization grant, a licence query for a product, a signed download URL per release, a runtime licence check. Designed 2026-09-05 in `sushiweb/docs/agent/specs/2026-09-05-device-grant-and-releases-design.md`, three plans, on branch `feat/device-grant-and-releases`. | none here |
